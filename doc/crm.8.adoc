...
colocation <id> <score>: <rsc>[:<role>] <with-rsc>[:<role>]
  [node-attribute=<node_attr>] [<lifetime>]
...
Usage:
...............
location <id> <rsc> [<attributes>] {<node_pref>|<rules>} [<lifetime>]
...
Usage:
...............
order <id> [<lifetime>] [{kind|<score>}:] first then [symmetrical=<bool>]

order <id> [<lifetime>] [{kind|<score>}:] resource_sets [symmetrical=<bool>]
