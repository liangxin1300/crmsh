...
""", add_help=False, formatter_class=RawDescriptionHelpFormatter)
        ...
        qdevice_group.add_argument("--qdevice-tls",
        ...
        qdevice_group.add_argument("--qdevice-heuristics-mode",
                                   dest="qdevice_heuristics_mode", metavar="MODE",
