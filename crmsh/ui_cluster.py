...
""", add_help_option=False)
        ...
        parser.add_option("-y", "--yes", action="store_true", dest="yes_to_all",
                          help='Answer "yes" to all prompts (use with caution, this is destructive, especially during the "storage" stage, and the SSH key will be overwritten unless with "--no-overwrite-sshkey" option)')
        ...
        parser.add_option("--no-overwrite-sshkey", action="store_true", dest="no_overwrite_sshkey",
                          help='Should be used with "-y" option to avoid SSH key be overwritten')
