...
class QDevice(object):
    ...
    def valid_attr(self):
        if self.ip == utils.this_node() or \
           self.ip in utils.ip_in_local():
    ...
    def remote_running_cluster(self):
        ...
        try:
            utils.parallax_call([self.ip], cmd, self.askpass)
        except ValueError:
            return False
        else:
            return True
    ...
    def fetch_qnetd_crt_from_qnetd(self):
        ...
        utils.parallax_slurp([self.ip], self.qdevice_path,
    ...
    def copy_qnetd_crt_to_cluster(self):
        ...
        utils.parallax_copy(node_list, os.path.dirname(self.qnetd_cacert_on_local),
    ...
    def init_db_on_cluster(self):
        ...
        utils.parallax_call(node_list, cmd, self.askpass)
    ...
    def copy_crq_to_qnetd(self):
        ...
        utils.parallax_copy([self.ip], self.qdevice_crq_on_local,
    ...
    def copy_p12_to_cluster(self):
        ...
        utils.parallax_copy(node_list, self.qdevice_p12_on_local,
    ...
    def fetch_qnetd_crt_from_cluster(self):
        ...
        utils.parallax_slurp([self.cluster_node], self.qdevice_path,
